      ...
      <Row>
        <Col className="col-12 col-lg-6">
          ...
          <Row className="d-flex justify-content-star">
            <Col className="col-5 col-lg-4">
              ...
              <GlobalButton name="Edit Profile" bgColor="#433434" className="w-100 mt-3 border-0" onClick={() => navigate(`/profile/edit/${userProfile?.id}`)} />
            </Col>
            <Col>
              <div>
        ...
        <Col className="col-12 col-lg-6">
          ...
          <div style={{ maxHeight: "300px", overflow: "scroll" }}>
            <Card className="shadow d-flex flex-row justify-content-between p-2 mb-3" style={{ borderBox: "box-sizing" }}>
